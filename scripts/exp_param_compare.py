...
ORIG = {"MOM_PERIODS": rq.MOM_PERIODS, "MOM_WEIGHTS": rq.MOM_WEIGHTS,
...
def run_config(data, cfg):
    ...
    yearly = {}
    for y in years:
        r = backtest(data, select_wrapper, {}, rebal,
...
def main() -> None:
    ...
    print("=" * 108)
    hdr = f"  {'配置':<28}" + "".join(f"{y:>8}" for y in years) + \
    ...
    for cfg in CONFIGS:
        ...
        print(f"  {name:<28}{cells}{full['total_return']*100:>+9.0f}%"
